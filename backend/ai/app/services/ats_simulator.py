...
def simulate_ats(resume_text: str, ats_target: str) -> dict:
    ...
    if profile.strip_tables and ("|" in resume_text or "\t" in resume_text):
    ...
    if profile.column_flattening_risk == "high" and "column" in resume_text.lower():
